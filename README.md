...
1. Export the newsletter files from Braze in the following format:
   ...
   For Youbravo: `20260519_IT_TP_BLAST_Youbravo#11_20260522111325.html`

   For Aurora No Coupon: `20260415_IT_PT_NEWSLETTER_AURORA_#1_No_Coupon_20260522113851.html`

   For Aurora Coupon: `20260415_IT_PT_NEWSLETTER_AURORA_#1_Coupon_20260522112504.html`



3. Drag and drop the html files to the URL below and hit 'Commit changes' button:
   
   https://github.com/ub-anton/ub-newsletters/upload/main/raw-newsletters/incoming/



4. After a few minutes, check Webflow page:
